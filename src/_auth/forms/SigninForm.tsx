...
const SigninForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SigninValidation>) {
    console.log("line 39 sign in")
    const session = await signInAccount({
      email: values.email,
      password: values.password
    })
    console.log("line 44 sign in")
    console.log(session)
    if(!session){
      console.log("session doesn't work")
        return toast({
          title: "Error, Sign In Failed, please try again",
        })
    }
  ...
  return (
       <Form {...form}>
          <div className="sm:w-420 flex-center flex-col">
            ...
            <p className="text-light-3 small-meduim md:base-regular">To Log In, please enter your details</p>
